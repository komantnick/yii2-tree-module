	...
	<div class="panel panel-info">
		...
		<div class="panel-body">
			<?php 
			    ...
			    'action'=>"index.php?r=cabinet%2Funblock-node"
			])
			?>			
			<?= $form->field($model, 'form')->dropdownList(ClosureTable::find()->select(['node_title', 'node_id'])->where(['node_status'=>0])->indexBy('node_id')->column())->label('Выберите Узел'); ?>
