	...
	<div class="panel panel-info">
		...
		<div class="panel-body">
			<?php 
			    ...
			    'action'=>"index.php?r=nested-sets%2Fnode-add"
			])
			?>			
			<?= $form->field($model2, 'form')->dropdownList(NestedSets::find()->select(['node_title', 'node_id'])->indexBy('node_id')->column())->label('Выберите Родительский Узел'); ?>
