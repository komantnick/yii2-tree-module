	...
	<div class="panel panel-info">
		...
		<div class="panel-body">
			<?php 
			    ...
			    'action'=>"index.php?r=nested-sets%2Fparent-tree"
			])
			?>			
			<?= $form->field($model, 'form')->dropdownList(NestedSets::find()->select(['node_title', 'node_id'])->where(['node_status'=>1])->indexBy('node_id')->column())->label('Выберите Узел'); ?>
